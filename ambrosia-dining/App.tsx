            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-right">
                <button 
                  ...
                  className="inline-flex items-center gap-2 bg-gold-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-gold-500 transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
